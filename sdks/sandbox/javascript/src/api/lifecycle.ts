...
export interface paths {
    ...
    "/sandboxes/{sandboxId}/resources": {
         ...
         * @description Asynchronously updates the desired CPU and memory requests or limits for
        ...
        patch: {
            ...
            requestBody: {
                content: {
                     ...
                     *     }
                     */
                    "application/json": components["schemas"]["PatchSandboxResourcesRequest"];
                };
            };
            responses: {
                /** @description Desired resources were recorded in a new BatchSandbox generation. */
                202: {
                    headers: {
                        "X-Request-ID": components["headers"]["XRequestId"];
                        [name: string]: unknown;
                    ...
                    content: {
                        "application/json": components["schemas"]["PatchSandboxResourcesResponse"];
                    };
                };
                400: components["responses"]["BadRequest"];
                401: components["responses"]["Unauthorized"];
                ...
                500: components["responses"]["InternalServerError"];
                /** @description The selected runtime or Pool allocation does not support in-place resource resize. */
                501: {
                    headers: {
                        [name: string]: unknown;
                    };
...
export interface components {
    schemas: {
        ...
        /**
         * @description Partial update for CPU and memory resource requirements. At least one of
        ...
        PatchSandboxResourcesRequest: {
            resourceLimits?: components["schemas"]["CPUAndMemoryResources"];
            resourceRequests?: components["schemas"]["CPUAndMemoryResources"];
        };
        PatchSandboxResourcesResponse: {
            /** @description BatchSandbox generation carrying the desired resources. */
            generation: number;
